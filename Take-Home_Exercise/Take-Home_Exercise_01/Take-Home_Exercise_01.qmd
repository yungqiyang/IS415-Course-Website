...
kde_central_grab_weekend_diggle_bw.km <- density(central_grab_ppp.km, sigma=bw.diggle, edge=TRUE, kernel="gaussian")

kde_central_grab_weekday_diggle_bw.km <- density(central_grab_ppp.km, sigma=bw.diggle, edge=TRUE, kernel="gaussian")
...
kde_central_grab_weekend_ppp_adaptive <- adaptive.density(central_grab_ppp.km, method="kernel")

kde_central_grab_weekday_ppp_adaptive <- adaptive.density(central_grab_ppp.km, method="kernel")
